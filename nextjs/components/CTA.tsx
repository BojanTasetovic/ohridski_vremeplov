...
export default function CTA() {
  return (
    <section className="cta-section" id="cta">
      ...
      <Image className="cta-bg-logo" src="/logo/bronze_OTT.png" alt="Охридски Времеплов лого" width={0} height={0} sizes="min(680px,90vw)" style={{ width: 'min(680px,90vw)', height: 'auto' }} />
