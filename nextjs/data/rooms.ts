...
export const rooms: Room[] = [
  {
    ...
    image: '/images/patuvanje-niz-vremeto.jpg',
    video: '/videos/patuvanje-niz-vremeto-hero.mp4',
    cardVideo: '/videos/patuvanje-niz-vremeto-hero.mp4',
  ...
  },
  {
    ...
    text: 'Дигитална жива лабораторија за биолошката разновидност на Охридското Езеро, живо доживување каде секој со секој допир „оживуваат" ендемските видови што постојат само овде, секој контакт открива нова тајна од подводниот свет. Ова е шанса да се почувствува езерото како жив организам.\n\nУникатна можност да нурнете во виртуелен аквариум и да ја доживеете магијата на природата што реагира на вашето присуство.',
  },
  {
    slug: 'umetnost',
    tag: '02 · Уметност',
    ...
    image: '/images/umetnost.jpg',
    video: '/videos/umetnost-hero.mp4',
    cardVideo: '/videos/umetnost-hero.mp4',
    images: [
    ...
    text: 'Интерактивна изложба на уметноста низ вековите. Кратките видеа и дигитални репродукции на познати дела ја претставуваат убавината на творештвото. Ќе можете и да се насликате себеси во охридски стил, со што ќе станете дел од живата традиција на градот. Инспиративно патување што ја слави моќта на уметноста да обединува и да создава нови перспективи, каде секој посетител станува дел од приказната.',
  },
  {
    slug: 'tancot-i-muzikata',
    tag: '03 · Традиции',
    name: 'Соба на',
    nameEm: 'танцот и музиката',
    ...
    image: '/images/kultura-hero.jpg',
    gradient: 'linear-gradient(155deg,#d8d0a8 0%,#b8a860 100%)',
    text: 'Во овој простор се слави животот, културата оживува преку движење. Секој чекор се претвора во игра, тука ќе научите да играте традиционални македонски ора. Учењето станува забава, а танцот — мост меѓу минатото и сегашноста. Незаборавно искуство што ја слави живата традиција и ја претвора во современа авантура.',
  },
  {
    slug: 'nostalgia',
    tag: '04 · Носталгија',
    ...
    text: 'Ретро стилизиран простор како каде амбиентот носи носталгија и топлина. Оваа соба е место за одмор и уживање, каде можете да се препуштите на спомените и да ја почувствувате културата како дел од живото наследство. Супер можност да се нурнете во ретро светот и да ја доживеете магијата на времето што оставило трага и денес.',
  },
  {
    slug: 'soba-na-arhitektura',
    tag: '05 · Простор',
    name: 'Соба на',
    nameEm: 'Архитектурата',
    desc: 'Виртуелна прошетка низ објекти — аугментирана реалност открива нови перспективи.',
    image: '/images/arhitektura-card.jpg',
  ...
  },
  {
    ...
    text: 'Овде ќе ја почувствувате писменоста како живо наследство, преку просторот за учење и приказна од охридското народно или авторско творештво. Преку паметна технологија ќе го допрете духот на писменоста и ќе разберете зошто е важно зачувувањето на јазикот и неговата моќ да обединува.',
  },
  {
    slug: 'vojni',
    tag: '07 · Конфликт',
    ...
    text: 'Емоционално патување низ воената историја на Охрид. Моќна приказна за жртвите и страдањата, за тежината на воените дејства проследено со звучни ефекти, потенцирајќи ја цената на мирот и силата на човечката издржливост. Проекцијата е покана да се почувствува историјата како ехо, да се оддаде почит и да се разбере значењето на мирот денес.',
  },
  {
    slug: 'idnina',
    tag: '08 · Иднина',
    ...
    text: 'Место за надеж и визија. Преку интерактивни технологии, просторот станува живо платно каде мислите и соништата се претвораат идна реалност, каде оставате своја порака за утре, своја желба за тоа како би сакал да изгледа Охрид во иднина. Инспиративно доживување што ја слави надежта за утре и ја претвора во заедничка визија.',
  },
];
