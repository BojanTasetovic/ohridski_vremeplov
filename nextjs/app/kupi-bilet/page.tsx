...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://ohridski-vremeplov.vercel.app/kupi-bilet' },
};
...
export default function KupiKartaPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        <section className="vlez-hero">
          <div className="vlez-hero-content">
            ...
            <p className="vlez-lead">
              Добредојдовте во Охридскиот Времеплов — првиот целосно интерактивен дигитален музеј во градот. Ве очекува 60-минутна незаборавна аудио-визуелна авантура која ве води низ 10 возбудливи поглавја на Охрид.<br />Изберете го вашиот билет и резервирајте го вашиот термин уште денес.
            </p>
          </div>
        </section>
        ...
        <section className="vlez-split">
          <div className="vlez-included">
            ...
            <p className="vlez-lead" style={{ color: 'var(--dark)', position: 'relative', zIndex: 2, marginBottom: '24px' }}>Вашиот билет ви овозможува целосен пристап до магијата на Охридскиот Времеплов:</p>
            <ul className="vlez-list">
              <li>
                <span className="vlez-list-num">10</span>
                <div>
                  <strong>Тематски соби</strong>
                  <p>Простор од над 680 м² исполнет со дигитални проекции, холограми и звучни ефекти.</p>
                </div>
              </li>
              <li>
          ...
          <div className="vlez-info">
            ...
            <p className="vlez-lead" style={{ color: 'var(--dark)', marginBottom: '24px' }}>За да ви овозможиме најдобро можно искуство и непрекинат тек на дигиталните содржини, ве молиме имајте го предвид следново:</p>
            <ul className="vlez-info-list">
              <li>
                <span className="vlez-info-icon">◎</span>
                <div>
                  <strong>Точност</strong>
                  <p>Турите во музејот се целосно автоматизирани и започнуваат точно на секои 20 минути.</p>
                </div>
              </li>
              <li>
                <span className="vlez-info-icon">◎</span>
                <div>
                  ...
                  <p>Ве молиме пристигнете најмалку 10 минути пред вашиот резервиран термин за валидација на билетите. Во случај на доцнење, поради природата на дигиталната програма, ќе мора да ја почекате следната слободна група (доколку има слободни места).</p>
                </div>
              </li>
            </ul>
          </div>
